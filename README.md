...
The `grab import <url> [options]` command can be used to automatically import GitHub releases into the local repository. Simply provide any GitHub repository URL:
